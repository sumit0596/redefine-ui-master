...
@Component({
  selector: 'app-os-analytics',
  templateUrl: './os-analytics.component.html',
  styleUrls: ['./os-analytics.component.scss']
})
export class OsAnalyticsComponent {
  ...
  getOSAnalyticsData(){
    ...
    this.chartData$ = this.dashboardService.getOSSplit(
      this.filter
    ).pipe(map(e => {
        return e;
      }
