...
@Component({
  ...
  styleUrls: ['./job-listing-dialog.component.scss'],
})
export class JobListingDialogComponent {
  filterForm!: FormGroup;
  previousSelection: any;
  jobListingStatus$: Observable<any[]> = of([
    {
      Id: 0,
      Name: 'Draft',
    },
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<JobListingDialogComponent>,
