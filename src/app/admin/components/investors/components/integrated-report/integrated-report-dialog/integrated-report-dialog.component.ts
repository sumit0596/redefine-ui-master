...
@Component({
  selector: 'app-integrated-report-dialog',
  templateUrl: './integrated-report-dialog.component.html',
  styleUrls: ['./integrated-report-dialog.component.scss'],
})
export class IntegratedReportDialogComponent {
