...
@Component({
  selector: 'app-debt-programme-dialog',
  templateUrl: './debt-programme-dialog.component.html',
  styleUrls: ['./debt-programme-dialog.component.scss'],
})
export class DebtProgrammeDialogComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DebtProgrammeDialogComponent>,
